...
neural_net = ConvNet(input_len = input_size, 
                     ...
                     pool_kernel_size_c3 = pooling_kernel_size_c3,
                     h1_size = h1_size, 
                     h2_size = h2_size, 
                     dropout_p = dropout_p)
...
torch.manual_seed(1)
bs = snakemake.params.batch_size
