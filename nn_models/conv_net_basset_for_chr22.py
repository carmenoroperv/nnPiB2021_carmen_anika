...
class ConvNet(torch.nn.Module):
    ...
    def __init__(self, input_len, 
        ...
        self.conv3 = torch.nn.Conv1d(in_channels=num_channels_c1, out_channels=num_channels_c3, kernel_size=conv_kernel_size_nts_c3 * 4, stride = conv_kernel_stride)
        ...
        pool_c3_output_size = calc_pool_output_size(n = calc_conv_layer_output_size(n = pool_c1_output_size, 
        ...
        flat_size = calc_flat_output_size(second_dim = num_channels_c3, third_dim = pool_c3_output_size)
        
        self.h1 = torch.nn.Linear(flat_size, h1_size)
        self.dropout_h1 = nn.Dropout(0.3) 
        
        self.h2 = torch.nn.Linear(h1_size, h2_size)
        self.dropout_h2 = nn.Dropout(0.3) 
